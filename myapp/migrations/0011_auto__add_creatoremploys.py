...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CreatorEmploys'
        db.create_table('myapp_creatoremploys', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employ', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myapp.Employ'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myapp.Creator'])),
        ))
        db.send_create_signal('myapp', ['CreatorEmploys'])


    def backwards(self, orm):
        # Deleting model 'CreatorEmploys'
        db.delete_table('myapp_creatoremploys')
