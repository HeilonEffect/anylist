...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Creator.employ'
        db.delete_column('myapp_creator', 'employ_id')


    def backwards(self, orm):
        # Adding field 'Creator.employ'
        db.add_column('myapp_creator', 'employ',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myapp.Employ'], default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'myapp.serie': {
            ...
            'season': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['myapp.SeriesGroup']", 'blank': 'True', 'null': 'True'}),
