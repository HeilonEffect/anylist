...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hero.actor'
        db.add_column('myapp_hero', 'actor',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['myapp.Creator'], blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Hero.actor'
        db.delete_column('myapp_hero', 'actor_id')
    ...
    models = {
        ...
        'myapp.hero': {
            ...
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['myapp.Creator']", 'blank': 'True'}),
            'avatar': ('django.db.models.fields.files.ImageField', [], {'null': 'True', 'max_length': '100', 'blank': 'True'}),
