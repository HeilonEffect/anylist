...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserList.score'
        db.alter_column('myapp_userlist', 'score', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserList.score'
        db.alter_column('myapp_userlist', 'score', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0))
