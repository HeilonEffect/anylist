...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('myapp_seriesgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(blank=True, null=True)),
        ...
        db.send_create_signal('myapp', ['SeriesGroup'])


        # Changing field 'Serie.length'
        db.alter_column('myapp_serie', 'length', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Renaming column for 'Serie.num_season' to match new field type.
        db.rename_column('myapp_serie', 'num_season', 'num_season_id')
        # Changing field 'Serie.num_season'
        db.alter_column('myapp_serie', 'num_season_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['myapp.SeriesGroup']))
        # Adding index on 'Serie', fields ['num_season']
        db.create_index('myapp_serie', ['num_season_id'])


        # Changing field 'Serie.number'
        db.alter_column('myapp_serie', 'number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):
        # Removing index on 'Serie', fields ['num_season']
        db.delete_index('myapp_serie', ['num_season_id'])

        # Deleting model 'SeriesGroup'
        db.delete_table('myapp_seriesgroup')


        # Changing field 'Serie.length'
        db.alter_column('myapp_serie', 'length', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))

        # Renaming column for 'Serie.num_season' to match new field type.
        db.rename_column('myapp_serie', 'num_season_id', 'num_season')
        # Changing field 'Serie.num_season'
        db.alter_column('myapp_serie', 'num_season', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))

        # Changing field 'Serie.number'
        db.alter_column('myapp_serie', 'number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1))
    ...
    models = {
        ...
        'myapp.serie': {
            ...
            'num_season': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['myapp.SeriesGroup']"}),
