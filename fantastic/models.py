...
class Book(AbstractProduct):
	def get_absolute_url(self):
		...
		return '/fantastic-books' % result


class Video(AbstractProduct):
	def get_absolute_url(self):
		result = super(Video, self).get_absolute_url()
		return '/fantastic-video' % result


class Comix(AbstractProduct):
	def get_absolute_url(self):
		result = super(Comix, self).get_absolute_url()
		return '/fantastic-comix' % result
