...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Status'
        db.create_table('apps_status', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15)),
        ))
        db.send_create_signal('apps', ['Status'])

        # Adding model 'ListedProduct'
        db.create_table('apps_listedproduct', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('apps', ['ListedProduct'])

        # Adding M2M table for field series on 'ListedProduct'
        m2m_table_name = db.shorten_name('apps_listedproduct_series')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('listedproduct', models.ForeignKey(orm['apps.listedproduct'], null=False)),
            ('serie', models.ForeignKey(orm['apps.serie'], null=False))
        ))
        db.create_unique(m2m_table_name, ['listedproduct_id', 'serie_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('apps_status')

        # Deleting model 'ListedProduct'
        db.delete_table('apps_listedproduct')

        # Removing M2M table for field series on 'ListedProduct'
        db.delete_table(db.shorten_name('apps_listedproduct_series'))
    ...
    models = {
        ...
        'apps.userlist': {
            ...
            'content': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['apps.ListedProduct']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
