...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apps_serie', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['apps.Production']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Serie.product'
        db.delete_column('apps_serie', 'product_id')
