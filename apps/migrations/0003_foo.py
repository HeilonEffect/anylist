...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Serie'
        db.create_table('apps_serie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('season', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['apps.SeriesGroup'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('apps', ['Serie'])
