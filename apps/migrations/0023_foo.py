...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('apps', ['Season'])


        # Renaming column for 'Serie.num_season' to match new field type.
        db.rename_column('apps_serie', 'num_season', 'num_season_id')
        # Changing field 'Serie.num_season'
        db.alter_column('apps_serie', 'num_season_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['apps.Season']))
        # Adding index on 'Serie', fields ['num_season']
        db.create_index('apps_serie', ['num_season_id'])


        # Changing field 'Serie.name'
        db.alter_column('apps_serie', 'name', self.gf('django.db.models.fields.CharField')(null=True, max_length=255))

    def backwards(self, orm):
        # Removing index on 'Serie', fields ['num_season']
        db.delete_index('apps_serie', ['num_season_id'])

        # Deleting model 'Season'
        db.delete_table('apps_season')


        # Renaming column for 'Serie.num_season' to match new field type.
        db.rename_column('apps_serie', 'num_season_id', 'num_season')
        # Changing field 'Serie.num_season'
        db.alter_column('apps_serie', 'num_season', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Serie.name'
        db.alter_column('apps_serie', 'name', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))
    ...
    models = {
        ...
        'apps.serie': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '255'}),
            'num_season': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['apps.Season']"}),
