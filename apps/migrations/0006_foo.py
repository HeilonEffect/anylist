...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('apps_serie', 'length', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Serie.length'
        db.alter_column('apps_serie', 'length', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 6, 2, 0, 0)))
