...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Production.pub_date'
        db.add_column('apps_production', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 8, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Production.pub_date'
        db.delete_column('apps_production', 'pub_date')
    ...
    models = {
        ...
        'apps.listedproduct': {
            ...
            'series': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['apps.Serie']", 'null': 'True'}),
