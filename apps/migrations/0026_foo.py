...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Criminalystic'
        db.create_table('apps_criminalystic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('link', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['apps.Production'])),
        ))
        db.send_create_signal('apps', ['Criminalystic'])


    def backwards(self, orm):
        # Deleting model 'Criminalystic'
        db.delete_table('apps_criminalystic')
    ...
    models = {
        ...
        'apps.criminalystic': {
            'Meta': {'object_name': 'Criminalystic'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'to': "orm['apps.Production']"})
        },
        'apps.dashboard': {
